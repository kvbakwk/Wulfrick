...
const editMsg = (c, msg1, msg2) => {
    ...
    const embed = new EmbedBuilder()
        ...
        .setFooter({ text: `Data: ${msg2.createdAt.getDate()}/${msg2.createdAt.getMonth() + 1}/${msg2.createdAt.getFullYear()} • Godzina: ${msg2.createdAt.getHours() < 10 ? '0' + msg2.createdAt.getHours() : msg2.createdAt.getHours()}:${msg2.createdAt.getMinutes() < 10 ? '0' + msg2.createdAt.getMinutes() : msg2.createdAt.getMinutes()}.${msg2.createdAt.getSeconds()}` })
